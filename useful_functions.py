...
def make_confusion_matrix(y_true, y_pred, classes=None, figsize=(10, 10), text_size=15, norm=False, savefig=False): 
  ...
  # Plotting the figure and make it pretty
  ...
  # Making x-axis labels appear on bottom
  ax.xaxis.set_label_position("bottom")
  ax.xaxis.tick_bottom()

  # Setting the threshold for different colors
  ...
  # Saving the figure to the current working directory
  if savefig:
...
def pred_and_plot(model, filename, class_names):
  ...
  """
  # Importing the target image and preprocess it
